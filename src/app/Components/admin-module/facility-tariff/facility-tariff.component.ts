...
@Component({
  selector: 'app-facility-tariff',
  templateUrl: './facility-tariff.component.html',
  styleUrls: ['./facility-tariff.component.css',"../../../../css/buttons.bootstrap4.min.css" ,
...
export class FacilityTariffComponent implements OnInit {
...
}else 
{
  ...
  LoadVitalSignsData(event:any)
  {
    ...
    this.service.GetFecilityTariffDetails(this.VaitalInput.OrganizationId,FacilityId).subscribe(result=>{
  ...
  {
    debugger
    this.service.RemoveFacilityTariffChargeId(valueObj.facility_Tariff_Id).subscribe(((result)=>{
      if(result>0)
      {
...
if(this.myform.invalid)
{
  ...
  const dialogRef=this.pop.open(FacilitiTariffComponent,{
    width:"60%",
    height:"310px",
    data:facilityid
...
if(this.myform.invalid)
{
  ...
  const dialogRef=this.pop.open(EditFacilityTariffComponent,{
    width:"60%",
    height:"310px",
    // data:facilityid,
    data:valueObj
...
}else if(control instanceof FormGroup)
{
  ...
  ngOnInit(): void {
    ...
    localStorage.setItem('header','Facility Tariff')
  }
