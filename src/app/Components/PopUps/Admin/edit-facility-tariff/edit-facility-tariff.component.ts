...
@Component({
  selector: 'app-edit-facility-tariff',
  templateUrl: './edit-facility-tariff.component.html',
  styleUrls: ['./edit-facility-tariff.component.css',"../../../../../css/style.css","../../../../../css/bootstrap.min.css"
  ,"../../../../../css/responsive.bootstrap4.min.css","../../../../../css/buttons.bootstrap4.min.css" ,
  "../../../../../css/dataTables.bootstrap4.min.css","../../../../../css/metisMenu.min.css"]
})
export class EditFacilityTariffComponent implements OnInit {
...
this.myform.get('ChargeItemId').patchValue(d.charge_Item_Id.toString());
      ...
      (<HTMLInputElement>document.getElementById('UnitPrice_0')).value=d.unit_Price.toString();

    debugger
    }); 
    debugger
    this.rowlist1=[{Sno:1,Organization:localStorage.getItem('organizationId'),FacilityId:this.Data,
...
debugger
  ...
  LoadChargeItemData(event:any,index:number)
  {
    debugger
...
this.rowlist1= this.rowlist1.filter(x=>x.Sno!=value.Sno)
  ...
  fetchFAddress(index:number,event:any)
  {
    ...
    this.rowlist1[index].Organization=localStorage.getItem('organizationId')
    this.rowlist1[index].FacilityId=this.Data.facility_Id;
    // this.rowlist1[index].ChargeItemId=(<HTMLInputElement>document.getElementById('chargeitemid'+index)).value ;
...
if(k==0)
{
 ...
 let istrue=false;
    ...
    if(istrue==false)
    {
      ...
      this.rowlist2[0].FacilityChargeId=this.Data.facility_Tariff_Id.toString(); 
      this.rowlist2[0].CreatedBy=this.user.getUserName()     
      let data=this.rowlist2[0];
      debugger;
        this.service.UpdateFacilityTariffDetails(data).subscribe((result)=>
      {
       debugger
        let r=result;
        if(r>0)
