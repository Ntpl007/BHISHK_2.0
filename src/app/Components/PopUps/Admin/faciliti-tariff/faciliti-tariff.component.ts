...
@Component({
  selector: 'app-faciliti-tariff',
  templateUrl: './faciliti-tariff.component.html',
  styleUrls: ['./faciliti-tariff.component.css',"../../../../../css/style.css","../../../../../css/bootstrap.min.css"
  ,"../../../../../css/responsive.bootstrap4.min.css","../../../../../css/buttons.bootstrap4.min.css" ,
  "../../../../../css/dataTables.bootstrap4.min.css","../../../../../css/metisMenu.min.css"]
})

export class FacilitiTariffComponent implements OnInit {
  myform:any
...
if(k==0)
{
 ...
 let istrue=false;
    ...
    if(istrue==false)
    {
      ...
      debugger;
       this.service.SaveFacilityTariffDetails(data).subscribe((result)=>
      {
       debugger
        let r=result;
        if(r>0)
