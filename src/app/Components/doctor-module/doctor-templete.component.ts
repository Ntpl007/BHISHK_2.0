...
@Component({
  selector: 'app-doctor-templete',
  templateUrl: './doctor-templete.component.html',
  styleUrls: ['./doctor-templete.component.css',"../../../css/style.css","../../../css/bootstrap.min.css"
  ,"../../../css/responsive.bootstrap4.min.css","../../../css/buttons.bootstrap4.min.css" ,
  "../../../css/dataTables.bootstrap4.min.css","../../../css/metisMenu.min.css"]
})
export class DoctorTempleteComponent implements OnInit {
